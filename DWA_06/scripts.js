...
/**
 * An object literal that contains reference to all the HTML elements
 * reference through the operation of the app. This ensures all UI 
 * elements can be accessed and seen in a structured manner in a single
 * data structure.
 * 
